...
cd ghc-prim
./Setup configure --builddir $TOP/dist/ghc-prim --package-db=$TOP/package.conf.d --prefix $TOP
...
cd integer-gmp
./Setup configure --builddir $TOP/dist/integer-gmp --package-db=$TOP/package.conf.d --prefix $TOP
...
ghc base/Setup.hs
cd base
./Setup configure --builddir $TOP/dist/base --package-db=$TOP/package.conf.d --prefix $TOP -finteger-gmp
