...
getOrSetSystemEventThreadEventManagerStore = getOrSetSystemEventThreadEventManagerStore
...
getOrSetSystemEventThreadIOManagerThreadStore = getOrSetSystemEventThreadIOManagerThreadStore
...
getOrSetSystemTimerThreadEventManagerStore = getOrSetSystemTimerThreadEventManagerStore
...
c_setIOManagerControlFd = c_setIOManagerControlFd

c_setTimerManagerControlFd :: CInt -> IO ()
c_setTimerManagerControlFd = c_setTimerManagerControlFd
