...
libdw_pool_take = libdw_pool_take

libdw_pool_release :: FunPtr (Ptr Session -> IO ())
libdw_pool_release = libdw_pool_release

libdw_pool_clear :: IO ()
libdw_pool_clear = libdw_pool_clear

libdw_lookup_location :: Ptr Session -> Ptr Location -> Addr -> IO CInt
libdw_lookup_location = libdw_lookup_location

libdw_get_backtrace :: Ptr Session -> IO (Ptr StackTrace)
libdw_get_backtrace = libdw_get_backtrace

backtrace_free :: FunPtr (Ptr StackTrace -> IO ())
backtrace_free = backtrace_free
