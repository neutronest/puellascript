...
stgWord32ToFloat = stgWord32ToFloat
...
stgFloatToWord32 = stgFloatToWord32
...
stgWord64ToDouble = stgWord64ToDouble
#else
...
stgDoubleToWord64 = stgDoubleToWord64
#else
