...
getOrSetGHCConcWindowsPendingDelaysStore = getOrSetGHCConcWindowsPendingDelaysStore
...
getOrSetGHCConcWindowsIOManagerThreadStore = getOrSetGHCConcWindowsIOManagerThreadStore
...
getMonotonicNSec = getMonotonicNSec
...
getOrSetGHCConcWindowsProddingStore = getOrSetGHCConcWindowsProddingStore
...
c_getIOManagerEvent = c_getIOManagerEvent

c_readIOManagerEvent :: IO Word32
c_readIOManagerEvent = c_readIOManagerEvent

c_sendIOManagerEvent :: Word32 -> IO ()
c_sendIOManagerEvent = c_sendIOManagerEvent

c_WaitForSingleObject :: HANDLE -> DWORD -> IO DWORD
c_WaitForSingleObject = c_WaitForSingleObject
