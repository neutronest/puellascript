...
rts_setThreadAllocationCounter = rts_setThreadAllocationCounter

rts_getThreadAllocationCounter :: ThreadId# -> IO Int64
rts_getThreadAllocationCounter = rts_getThreadAllocationCounter

rts_enableThreadAllocationLimit :: ThreadId# -> IO ()
rts_enableThreadAllocationLimit = rts_enableThreadAllocationLimit

rts_disableThreadAllocationLimit :: ThreadId# -> IO ()
rts_disableThreadAllocationLimit = rts_disableThreadAllocationLimit
...
c_setNumCapabilities = c_setNumCapabilities
...
c_getNumberOfProcessors = c_getNumberOfProcessors
...
c_reportStackOverflow = c_reportStackOverflow

reportHeapOverflow :: IO ()
reportHeapOverflow = reportHeapOverflow
