{-# LANGUAGE CPP, NondecreasingIndentation, NumDecimals #-}
...
getCurrentProcess :: IO (Ptr HANDLE)
getCurrentProcess = getCurrentProcess
getProcessTimes :: Ptr HANDLE -> Ptr FILETIME -> Ptr FILETIME -> Ptr FILETIME -> Ptr FILETIME -> IO CInt
