...
integer_gmp_powm# = integer_gmp_powm#
...
integer_gmp_powm1# :: ByteArray# -> GmpSize# -> ByteArray# -> GmpSize#
                        -> GmpLimb# -> GmpLimb#
integer_gmp_powm1# = integer_gmp_powm1#
...
integer_gmp_invert# :: MutableByteArray# RealWorld
                         -> ByteArray# -> GmpSize#
                         -> ByteArray# -> GmpSize# -> IO GmpSize
integer_gmp_invert# = integer_gmp_invert#
...
int_encodeDouble# = int_encodeDouble#
...
c_scan_nzbyte_addr = c_scan_nzbyte_addr

c_rscan_nzbyte_addr :: Addr# -> Word# -> Word# -> IO Word
c_rscan_nzbyte_addr = c_rscan_nzbyte_addr
...
c_mpn_import_addr :: MutableByteArray# RealWorld -> Addr# -> Word# -> Word#
                      -> Int# -> IO ()
c_mpn_import_addr = c_mpn_import_addr
...
c_scan_nzbyte_bytearray = c_scan_nzbyte_bytearray

c_rscan_nzbyte_bytearray :: ByteArray# -> Word# -> Word# -> IO Word
c_rscan_nzbyte_bytearray = c_rscan_nzbyte_bytearray
...
c_mpn_import_bytearray :: MutableByteArray# RealWorld -> ByteArray# -> Word#
                           -> Word# -> Int# -> IO ()
c_mpn_import_bytearray = c_mpn_import_bytearray
